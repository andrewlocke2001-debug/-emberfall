...
export const MOBS: Record<string, MobDef> = {
  ...
  cinder_husk: {
    ...
    drops: [
      { itemId: "coins", min: 12, max: 26, chance: 1 },
      { itemId: "ember_tear", min: 1, max: 1, chance: 0.5 },
      { itemId: "health_potion", min: 1, max: 1, chance: 0.1 },
    ],
    color: 0xc96f3a,
  },
  wound_wraith: {
    ...
    xpReward: 760,
    drops: [
      { itemId: "coins", min: 14, max: 30, chance: 1 },
      { itemId: "ember_tear", min: 1, max: 2, chance: 0.6 },
      { itemId: "ancient_relic", min: 1, max: 1, chance: 0.1 },
    ],
    color: 0xff9e5e,
  },
  throne_herald: {
    ...
    xpReward: 950,
    drops: [
      { itemId: "coins", min: 18, max: 36, chance: 1 },
      { itemId: "ember_tear", min: 1, max: 2, chance: 0.6 },
      { itemId: "wound_walker_boots", min: 1, max: 1, chance: 0.02 },
      { itemId: "cinder_heart", min: 1, max: 1, chance: 0.05 },
      { itemId: "health_potion", min: 1, max: 1, chance: 0.2 },
    ],
    color: 0xe8b13a,
  },
  pyre_admiral: {
    ...
    xpReward: 400,
    drops: [
      { itemId: "coins", min: 80, max: 150, chance: 1 },
      { itemId: "oarblade", min: 1, max: 1, chance: 0.3 },
      { itemId: "sea_wrack", min: 2, max: 3, chance: 1 },
      { itemId: "health_potion", min: 1, max: 1, chance: 0.5 },
    ],
    color: 0x4a6a78,
    boss: true,
    telegraph: { windupMs: 1500, radius: 130, damage: 40, cooldownMs: 8000 },
    mechanics: {
      addsAtHpPct: [
        { pct: 0.6, kind: "salt_shade", count: 2 },
  ...
  bell_foreman: {
    ...
    xpReward: 560,
    drops: [
      { itemId: "coins", min: 110, max: 190, chance: 1 },
      { itemId: "bell_maul", min: 1, max: 1, chance: 0.3 },
      { itemId: "iron_bar", min: 1, max: 2, chance: 1 },
      { itemId: "health_potion", min: 1, max: 1, chance: 0.5 },
    ],
    color: 0x9a8a5a,
    boss: true,
    telegraph: { windupMs: 1600, radius: 135, damage: 46, cooldownMs: 8000 },
    mechanics: {
  ...
  intake_overseer: {
    kind: "intake_overseer",
    name: "The Intake Overseer",
    level: 38,
    attack: 48,
    strength: 48,
    defence: 42,
    ...
    xpReward: 700,
    drops: [
      { itemId: "coins", min: 140, max: 230, chance: 1 },
      { itemId: "pressure_bow", min: 1, max: 1, chance: 0.3 },
      { itemId: "fen_amber", min: 2, max: 4, chance: 1 },
      { itemId: "health_potion", min: 1, max: 1, chance: 0.5 },
    ],
    color: 0xb08040,
    boss: true,
    telegraph: { windupMs: 1500, radius: 130, damage: 48, cooldownMs: 8000 },
    mechanics: {
      telegraphVolley: 3,
  ...
  provost_ilsever: {
    kind: "provost_ilsever",
    name: "Provost Ilsever",
    level: 60,
    attack: 70,
    strength: 66,
    defence: 62,
    ...
    xpReward: 2000,
    drops: [
      { itemId: "coins", min: 400, max: 700, chance: 1 },
      { itemId: "phylactery_lamp", min: 1, max: 1, chance: 0.25 },
      { itemId: "spark_siphon", min: 1, max: 1, chance: 0.15 },
      { itemId: "ancient_relic", min: 1, max: 2, chance: 1 },
      { itemId: "lamp_glass", min: 3, max: 5, chance: 1 },
    ],
    color: 0xe8cf7a,
    boss: true,
    ...
    mechanics: {
      ...
      telegraphVolley: 2,
      onHitEffect: { kind: "burn", damage: 12, durationMs: 6000 },
    },
  },
  wakespawn: {
    kind: "wakespawn",
    ...
    drops: [
      { itemId: "coins", min: 8, max: 18, chance: 1 },
      { itemId: "cinder_pearl", min: 1, max: 1, chance: 0.35 },
      { itemId: "health_potion", min: 1, max: 1, chance: 0.08 },
    ],
    color: 0x3f7d8c,
  },
  keel_shade: {
    ...
    drops: [
      { itemId: "coins", min: 10, max: 22, chance: 1 },
      { itemId: "cinder_pearl", min: 1, max: 1, chance: 0.15 },
      { itemId: "kettle_charm", min: 1, max: 1, chance: 0.04 },
      { itemId: "health_potion", min: 1, max: 1, chance: 0.08 },
    ],
    color: 0x8f9bae,
  },
  leviathanling: {
    ...
    xpReward: 330,
    drops: [
      { itemId: "coins", min: 14, max: 26, chance: 1 },
      { itemId: "leviathan_scale", min: 1, max: 1, chance: 0.4 },
      { itemId: "health_potion", min: 1, max: 1, chance: 0.1 },
    ],
    color: 0xd06a3f,
  },
  harbor_saint: {
    ...
    drops: [
      ...
      { itemId: "tide_knife", min: 1, max: 1, chance: 0.3 },
      { itemId: "kettle_charm", min: 1, max: 1, chance: 0.06 },
      { itemId: "branded_keelplate", min: 1, max: 1, chance: 1 },
      { itemId: "cinder_pearl", min: 2, max: 4, chance: 1 },
    ],
    color: 0x6fa89a,
    boss: true,
